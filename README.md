...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cryptography-vectors-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4777&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cryptography-vectors-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cryptography-vectors` can be installed with `conda`:
...
```
mamba install cryptography-vectors
```

It is possible to list all of the versions of `cryptography-vectors` available on your platform with `conda`:
...
```
mamba search cryptography-vectors --channel conda-forge
```
...
mamba repoquery search cryptography-vectors --channel conda-forge

# List packages depending on `cryptography-vectors`:
mamba repoquery whoneeds cryptography-vectors --channel conda-forge

# List dependencies of `cryptography-vectors`:
mamba repoquery depends cryptography-vectors --channel conda-forge
```
